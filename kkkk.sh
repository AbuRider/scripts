...
rm -rf device/xiaomi/earth kernel/xiaomi/earth vendor/xiaomi/earth vendor/evolution-priv/keys
rm -rf hardware/mediatek hardware/xiaomi device/mediatek/sepolicy_vndr packages/apps/EuiccPolicy
