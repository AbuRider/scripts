...
repo init -u https://github.com/AbuRider/platform_manifest.git -b w16.1 --git-lfs
/opt/crave/resync.sh || repo sync

git clone https://github.com/AbuRider/android_device_xiaomi_earth.git -b Aicp-16.1 device/xiaomi/earth
